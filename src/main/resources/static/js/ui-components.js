...
const renderDroneUIComponent = function (droneDTO) {
    return '<div id="ctrlPanel1'+droneDTO.id+'" droneId="'+droneDTO.id+'" class="dronesList-header">Drone: '+droneDTO.id +
        ...
        '<table><tr><td> </td>' +
        '<td> <input class="button" id="btnF'+droneDTO.id+'" type="button" value="FWDTHRUST" /></td>' +
        '<td> </td> </tr>' +
        '<tr> <td><input class="button" id="btnMvL'+droneDTO.id+'" type="button" value=" LEFT " /> </td>' +
        '<td> <input class="button" id="btnCncl'+droneDTO.id+'" type="button" value=" HOVERHOLD " /></td>' +
        '<td> <input class="button" id="btnMvR'+droneDTO.id+'" type="button" value=" RIGHT " /> </td></tr>' +
        '<tr> <td> </td>' +
        '<td><input class="button" id="btnB'+droneDTO.id+'" type="button" value="BWDTHRUST" /></td>' +
        '<td> </td></tr></table>  </div>' +

        '<div id="ctrlPanel3'+droneDTO.id+'" style="position: absolute; top: 25%;left:50px;">' +
        '<table><tr> <td> <input class="button" id="mStart'+droneDTO.id+'" type="button" value="START/PAUSE" /> </td></tr> ' +
        '<tr> <td> <input class="button" id="mCancel'+droneDTO.id+'" type="button" value="CLEARDATA" /> </td></tr>' +
        '</table></div>' +

        '<div id="ctrlPanel8'+droneDTO.id+'" style="position: absolute; top: 25%;right:50px;">' +
        ...
        '<input class="button" id="mRTL'+droneDTO.id+'" type="button" value="RTL"  style="width:16%;float:left;margin-left:15px;" />' +
